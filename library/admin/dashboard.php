...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>ARD | Admin Dash Board</title>
...
?>
            ...
            <div class="col-md-3 col-sm-3 rscol-xs-6">
                      <div class="alert alert-info back-widget-set text-center">
                            <i class="fa fa-users fa-5x"></i>
<?php 
$sql6 ="SELECT supid from tblsuppliers";
$query6 = $dbh -> prepare($sql1);
$query6->execute();
$results5=$query6->fetchAll(PDO::FETCH_OBJ);
$listdsups=$query6->rowCount();
?>

                            <h3><?php echo htmlentities($listdsups);?> </h3>
                           Listed Suppliers
                        </div>
                    </div>
